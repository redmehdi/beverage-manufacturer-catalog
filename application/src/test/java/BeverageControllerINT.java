...
public class BeverageControllerINT {
...
/**
    ...
    public void testHeight_whenExistData_shouldReturnSize() {
        ...
        BeverageEntity pokeSpeciesEntity1 = new BeverageEntity("red", "Red1", "test", "eee", pokeCharacterEntity1);
        ...
        BeverageEntity pokeSpeciesEntity2 = new BeverageEntity("red", "Red1", "test", "eee", pokeCharacterEntity2);
    ...
    public void testHeight_whenExistData_shouldReturnTop5Height() {
        ...
        BeverageEntity pokeSpeciesEntity3 = new BeverageEntity("red", "Red1", "test", "eee", pokeCharacterEntity3);
        ...
        BeverageEntity pokeSpeciesEntity4 = new BeverageEntity("red", "Red1", "test", "eee", pokeCharacterEntity4);
        ...
        BeverageEntity pokeSpeciesEntity5 = new BeverageEntity("red", "Red1", "test", "eee", pokeCharacterEntity5);
        ...
        BeverageEntity pokeSpeciesEntity6 = new BeverageEntity("red", "Red1", "test", "eee", pokeCharacterSmallestOne);
        ...
        BeverageDto[] pokeSpecies = RestAssured.given().port(serverPort)
                .when()
                .get(POKE_HEIGHT_PATH)
                .as(BeverageDto[].class);
    ...
    private void assertEqualTop5(int smallestHeight, BeverageDto[] pokeSpecies) {
